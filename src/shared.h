 ...
 */
std::vector<std::string> list_devices( std::string dir, unsigned char ftype, bool rec=false );
 ...
 */
std::map< int, std::vector< std::string > > map_devices( std::string dir, bool rec=true );
